...
int main () {
	...
	*/
    ...
    ParamType mu = {0.01, 0.125};
    rb_truth.access_solver().access_params().tol = 1e-03*1e-02/3.;
...
/*
    ...
    saveCoeffVector2D(u, rb_base.rb_truth.access_solver().get_testbasis(),
                      "snap_mu2.txt");
    ...
    rb_base.set_tol(1e-03*1e-02*1e-01);
   ...
   */
    ...
    /*
        ...
        std::string     snapshot;
        std::string     plot;
        snapshot = "training_data_stempel/bf/bf_10.txt";
        plot     = "plot_bf10";
...
/*
    DataType u;
    readCoeffVector2D(u, "training_data_stempel/snap/snap_1.txt");
    ...
    sample_Au(rb_base.rb_truth.access_solver().get_testbasis(),
              _Lambda,
              (*rb_base.rb_truth.access_solver().get_lhs().get_localops()[0]),
    ...
    saveCoeffVector2D(Au, rb_base.rb_truth.access_solver().get_testbasis(),
                      "Au_snap1.txt");
