...
const FunctionSide    FctSide_Y                                     = Primal;
const Construction    Constr_Y                                      = Dijkema;
const Construction    RefConstr_Y                                   = Dijkema;
const FunctionSide    FctSide_X                                     = Orthogonal;
const Construction    Constr_X                                      = Multi;
const Construction    RefConstr_X                                   = MultiRefinement;
...
typedef RB_Base<RB_Model,MTTruthSolver,DataType,ParamType,IndexSet<Index2D>> RB_BaseModel;
...
{
    return (mu[0]-k12/k22)/(k11-k12*k21/k22);
}

T theta_2(const std::array<T,PDim>& mu)
{
    T mu1 = (mu[0]-k12/k22)/(k11-k12*k21/k22);
    return (1.-k21*mu1)/k22;
}
