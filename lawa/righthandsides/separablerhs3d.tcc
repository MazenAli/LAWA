...
template<typename T, typename Basis3D>
T
SeparableRHS3D<T, Basis3D>::operator()(XType xtype_x, FLENS_DEFAULT_INDEXTYPE j_x, FLENS_DEFAULT_INDEXTYPE k_x,
                                       ...
                                       XType xtype_z, FLENS_DEFAULT_INDEXTYPE j_z, FLENS_DEFAULT_INDEXTYPE k_z) const
{
    ...
    for (FLENS_DEFAULT_INDEXTYPE i=1; i<=deltas_z.numRows(); ++i) {
