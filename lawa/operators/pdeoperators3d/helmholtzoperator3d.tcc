...
template <typename T, typename Basis3D>
T
HelmholtzOperator3D<T, Basis3D>::operator()(XType row_xtype_x, FLENS_DEFAULT_INDEXTYPE j1_x, FLENS_DEFAULT_INDEXTYPE k1_x,
                                            XType row_xtype_y, FLENS_DEFAULT_INDEXTYPE j1_y, FLENS_DEFAULT_INDEXTYPE k1_y,
                                            XType row_xtype_z, FLENS_DEFAULT_INDEXTYPE j1_z, FLENS_DEFAULT_INDEXTYPE k1_z,
                                            XType col_xtype_x, FLENS_DEFAULT_INDEXTYPE j2_x, FLENS_DEFAULT_INDEXTYPE k2_x,
                                            XType col_xtype_y, FLENS_DEFAULT_INDEXTYPE j2_y, FLENS_DEFAULT_INDEXTYPE k2_y,
                                            XType col_xtype_z, FLENS_DEFAULT_INDEXTYPE j2_z, FLENS_DEFAULT_INDEXTYPE k2_z) const
{
