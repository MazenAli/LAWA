...
TransposedConvectionOperator1D_PG<T, TrialBasis, TestBasis>::TransposedConvectionOperator1D_PG(const TrialBasis& _trialbasis, const TestBasis& _testbasis)
...
template <typename T, typename TrialBasis, typename TestBasis>
T
TransposedConvectionOperator1D_PG<T, TrialBasis, TestBasis>::operator()(const Index1D &row_index, const Index1D &col_index) const
{
    return TransposedConvectionOperator1D_PG<T, TrialBasis, TestBasis>::operator()(row_index.xtype, row_index.j, row_index.k,
