...
WeightedHelmholtzOperator1D<T, Basis, Quad>::WeightedHelmholtzOperator1D(const Basis& _basis,
                                                                         ...
                                                                         FLENS_DEFAULT_INDEXTYPE order, const T left,
                                                                         const T right)
...
template <typename T, typename Basis, QuadratureType Quad>
T
WeightedHelmholtzOperator1D<T, Basis, Quad>::operator()(XType xtype1, FLENS_DEFAULT_INDEXTYPE j1, FLENS_DEFAULT_INDEXTYPE k1,
