...
TransposedWeightedPDEOperator1D_PG<T, TrialBasis, TestBasis>::
TransposedWeightedPDEOperator1D_PG(const TrialBasis& _trialbasis, const TestBasis& _testbasis,
                                            		    	   	   	   	 ...
                                            		    	   	   	   	 XType xtype2, int j2, long k2) const
{
    ...
    T val_convection  = convectionIsZero ? 0. : convection_integral(j2,k2,xtype2,0, j1,k1,xtype1,1);
    T val_diffusion   = diffusionIsZero  ? 0. : diffusion_integral( j2,k2,xtype2,1, j1,k1,xtype1,1);
...
template <typename T, typename TrialBasis, typename TestBasis>
T
TransposedWeightedPDEOperator1D_PG<T, TrialBasis, TestBasis>::operator()(const Index1D &row_index, const Index1D &col_index)
const
{
