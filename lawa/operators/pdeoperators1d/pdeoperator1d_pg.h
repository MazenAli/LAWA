...
#ifndef LAWA_OPERATORS_PDEOPERATORS1D_PDEOPERATOR1D_PG_H
#define LAWA_OPERATORS_PDEOPERATORS1D_PDEOPERATOR1D_PG_H 1
...
/* PDE ConstCoefficient OPERATOR : Petrov-Galerkin version
 *
...
class PDEOperator1D_PG{
    ...
    public:
        ...
        PDEOperator1D_PG(const TrialBasis& _trialbasis, const TestBasis& _testbasis, T _reaction, T _convection, T _diffusion);
...
#include <lawa/operators/pdeoperators1d/pdeoperator1d_pg.tcc>

#endif  // LAWA_OPERATORS_PDEOPERATORS1D_PDEOPERATOR1D_PG_H
