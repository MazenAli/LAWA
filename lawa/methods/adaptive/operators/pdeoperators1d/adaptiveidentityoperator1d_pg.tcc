...
template <typename T, typename TrialBasis, typename TestBasis>
T
AdaptiveIdentityOperator1D_PG<T,TrialBasis,TestBasis>::operator()(const Index1D &row_index,
...
template <typename T, typename TrialBasis, typename TestBasis>
void
AdaptiveIdentityOperator1D_PG<T,TrialBasis,TestBasis>::toFlensSparseMatrix(const IndexSet<Index1D>& LambdaRow,
