...
TransposedAdaptiveLaplaceOperator1D_PG<T,TrialBasis,TestBasis>::
...
template <typename T, typename TrialBasis, typename TestBasis>
T
TransposedAdaptiveLaplaceOperator1D_PG<T,TrialBasis,TestBasis>::operator()(const Index1D &row_index,
