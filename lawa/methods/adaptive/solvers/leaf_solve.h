#ifndef LAWA_METHODS_ADAPTIVE_SOLVERS_LEAF_SOLVE_H
#define LAWA_METHODS_ADAPTIVE_SOLVERS_LEAF_SOLVE_H 1
...
#include <lawa/methods/adaptive/solvers/leaf_solve.tcc>

#endif // LAWA_METHODS_ADAPTIVE_SOLVERS_LEAF_SOLVE_H
